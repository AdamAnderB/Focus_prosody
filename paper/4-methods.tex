...
\begin{table}[h]
    ...
    \begin{tabular}{|l|l|l|}
        ...
        \hline
        Participants & 
        L1 English (Hong Kong), L1 Dutch (Netherlands), L1 Cantonese &
        L1 English (U.S.), L1 Dutch (Netherlands); no Cantonese group \\
        \hline
        Recruitment (L1 English) &
        University participant pool (Hong Kong; in-person) &
        Online recruitment via U.S. university participant pool (remote testing) \\
        \hline
        Recruitment (L1 Dutch) &
        University participant pool (Netherlands; in-person) &
        Online recruitment via \textit{Prolific} (L1 filters) \\
        \hline
        Modality & 
        Tobii eye-tracker (lab) &
        WebGazer.js (webcam-based, online) \\
        \hline
        Stimuli & 
        Original sentence-only materials &
        Same stimuli; added acoustic analysis \\
        \hline
        Analysis & 
        Time-binned LMMs &
        LMMs + GAMs + LASSO-GAMs \\
        \hline
    \end{tabular}
    }
    \caption{Key differences between Ge et al. (2021a) and the present close replication. Participant locations and recruitment procedures are detailed for transparency.}
