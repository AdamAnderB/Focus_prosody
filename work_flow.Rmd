...
all_fixations$time_cats_words <- factor(all_fixations$time_cats_words, 
  levels = c("         ", "The dinasaur is", "only", "verb1", "the1", 
...
gam_stats<- ge_data_mapped_clean %>%
  ...
  mutate(time_cats_words = case_when(
      ...
      time_cats == 12 ~ "offset",
      TRUE ~ NA_character_))%>%
    filter(time_cats_words=="The dinasaur is"|time_cats_words=="only"|
...
target_gam_model1 <- bam(value ~ s(time_cats,by = experiment_group) + experiment_group * condition +
                         s(participant.private.id, bs = "re"),
                         family = binomial(link = "logit"),  # Logistic regression
                         data = target_gam,
                         method = "fREML")
...
# Summary of model
summary(target_gam_model1)

target_gam_model2 <- bam(value ~ s(time_cats,by = experiment_group) + experiment_group + condition +
                         s(participant.private.id, bs = "re"),
                         family = binomial(link = "logit"),  # Logistic regression
                         data = target_gam,
                         method = "fREML")
...
competitor_gam_model1 <- bam(value ~ s(time_cats,by = experiment_group) + time_cats*experiment_group * condition +
                         s(participant.private.id, bs = "re"),
                         family = binomial(link = "logit"),  # Logistic regression
                         data = competitor_gam,
                         method = "fREML")
...
# Summary of model
summary(competitor_gam_model1)

competitor_gam_model2 <- bam(value ~ s(time_cats,by = experiment_group) + experiment_group + condition +
                         s(participant.private.id, bs = "re"),
                         family = binomial(link = "logit"),  # Logistic regression
                         data = competitor_gam,
                         method = "fREML")
